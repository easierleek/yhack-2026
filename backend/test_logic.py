...
check("20 degC -> 1.0 (normal)",     t2_demand_factor(20.0), 1.0)
check("25 degC -> 1.0 (upper edge)", t2_demand_factor(25.0), 1.0)
check("28 degC -> 1.0 (lower of >28 boundary)", t2_demand_factor(28.0), 1.0)
check("29 degC -> 1.2 (mild heat)", t2_demand_factor(29.0), 1.2)
check("36 degC -> 1.5 (extreme heat)", t2_demand_factor(36.0), 1.5)
check("12 degC -> 1.0 (upper cold boundary)", t2_demand_factor(12.0), 1.0)
check("11 degC -> 1.2 (mild cold)", t2_demand_factor(11.0), 1.2)
check("4 degC  -> 1.5 (extreme cold)", t2_demand_factor(4.0),  1.5)
check("-5 degC -> 1.5 (extreme cold)", t2_demand_factor(-5.0), 1.5)
...
check("t2_demand_factor = 1.0 at 22 degC",
